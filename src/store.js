...
class Store extends Component {
  ...
  render() {
    return (
      ...
      />
        <div>
        <img src={store1} className="images store1" />
        </div>
        <div>
        <img src={store2} className="images store2" />
        </div>
        <div>
        <img src={store3} className="images store3" />
        </div>
        <div>
        <img src={store4} className="images store4" />
        </div>
        <div>
        <img src={store5l} className="images store5l" />
        </div>
        <div>
        <img src={store5r} className="images store5r" />
        </div>
        <div>
        <a href="/burger">
        ...
        <div>
        <img src={store9} className="images store9" />
        </div>
        <div>
